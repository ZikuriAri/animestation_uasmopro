...
class _DetailAnimeWidgetState extends State<DetailAnimeWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: const Color(0xFFFCEFF6), // Warna background agar menyatu dengan gambar
        elevation: 0,
        leading: IconButton(
      ...
      body: Stack(
        children: [
          ...
          SingleChildScrollView(
            child: Column(
              children: [
                const SizedBox(height: 200), // Ruang agar background terlihat
                Container(
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => PlayScreen(
                                    ...
                                    animeId: widget.animeId, // Kirim animeId ke PlayScreen
                                  ),
                                ),
                              );
                            },
